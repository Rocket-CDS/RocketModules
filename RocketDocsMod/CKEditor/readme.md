The "scriptClassic.html" is the activation script for CKEditor.  

Inject via **AdminPanelHeader.cshtml**  
```
<script src="//@(portalData.EngineUrl)/DesktopModules/DNNrocketModules/<systemkey>/CKEditor/ckeditor.js"></script>
```

This version of CKEditor has a set of plugins to match the needs of Espace4x.
```
{
